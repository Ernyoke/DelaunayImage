...
public class VectorImageCreator extends ImageCreator {
    ...
    VectorImageCreator(List<List<Point>> triangles, Mat originalImage, FillColorInterface fillColor,
    ...
    public void createTriangle(List<Point> vertices) {
        int[] xVec = {(int) Math.ceil(vertices.get(0).x), (int) Math.ceil(vertices.get(1).x), (int) Math.ceil(vertices.get(2).x)};
        int[] yVec = {(int) Math.ceil(vertices.get(0).y), (int) Math.ceil(vertices.get(1).y), (int) Math.ceil(vertices.get(2).y)};
